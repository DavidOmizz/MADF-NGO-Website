  ...
  return (
    <div className=''>
        <div className='Section-One px-24'>
            <p className='text-center py-10 pb-5 text-2xl my-4 font-light text-neutral-800'>You can help lots of people by donating little. <strong className='text-3xl border-b-4 border-green-700 font-semibold'>See our causes</strong></p>
        ...
        <div className='bg-green-50 px-24 mt-28 pb-20'>
            <p className='text-center py-16 pb-10 text-2xl font-light mt-16'>How you can help? <strong className='font-semibold border-b-4 border-green-700'>See below</strong></p>
            <div className='flex gap-6 items-center py-5 justify-center'>
                <div>
                    <div className='flex gap-4 items-center mb-6'>
                        <div className='bg-green-500 p-4'>
                            <p className='text-white text-4xl font-bold'><GoMegaphone/></p>
                        </div>
                        <div>
                            <p className='font-semibold text-xl mb-2'>Media</p>
                            <p className='w-96 text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, dolore?Reiciendis, dolore?</p>
                        </div>
                    </div>
                    <div className='flex gap-4 items-center mb-6'>
                        <div className='bg-green-500 p-4'>
                            <p className='text-white text-4xl font-bold'><FaRegUser/></p>
                        </div>
                        <div>
                            <p className='font-semibold text-xl mb-2'>Media</p>
                            <p className='w-96 text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, dolore?Reiciendis, dolore?</p>
                    ...
                    <div className='flex gap-4 items-center mb-6'>
                        <div className='bg-green-500 p-4'>
                            <p className='text-white text-4xl font-bold'><FaRegHeart/></p>
                        </div>
                        <div>
                            <p className='font-semibold text-xl mb-2'>Media</p>
                            <p className='w-96 text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, dolore?Reiciendis, dolore?</p>
        ...
        {/* Be a volunteer  */}
        <div className='flex px-24 items-center bg-center bg-cover' style={{backgroundImage: `url(${sec3BgImage})`}}>
            <div className='py-24'>
                <p className='text-4xl font-thin mb-8'>Become <strong className='font-semibold border-b-2 border-green-700'>Volunteer</strong></p>
                <p className='w-96'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error quod eum natus cupiditate eveniet recusandae doloribus esse velit, quidem quibusdam.</p>
        ...
        <div className='px-24 py-16'>
            <p className='text-center mb-12 text-2xl font-light'>Checkout whats going on. <strong className='font-semibold border-b-2 border-green-700'>Latest News</strong></p>
        ...
        <div className='h-96 bg-center bg-no-repeat bg-cover' style={{backgroundImage: `url(${DImages})`}} >
            <div className='py-20 backdrop-brightness-50 bg-neutral-800/60 h-full text-center text-white'>
                <p className='text-2xl font-thin mb-8'>Donation Holders says <strong className='font-semibold border-b-2 border-green-500'>Read more</strong></p>
                <p className='w-6/12 mx-auto text-xl italic'>"Lorem ipsum dolor sit amet consectetur adipisicing elit consectetur adipisicing elit. Dolor nostrum cupiditate at dolorum? Assumenda, saepe!"</p>
        ...
        {/* footer  */}
        <footer>
            <div className='bg-neutral-900 px-24 flex gap-4 py-6'>
                ...
                <div className='text-neutral-400 py-10 text-sm'>
            ...
            <div className='bg-neutral-800 text-neutral-400 py-3 text-center text-sm'>
